...
def login_request(request):
    context = {}
    url = "https://27d31e05.eu-gb.apigw.appdomain.cloud/api/dealership"
...
def get_dealer_details(request, dealer_id):
    context={}
    url = "https://27d31e05.eu-gb.apigw.appdomain.cloud/api/review"
    apikey="_xKRLnH-xVpGqx9u0VBB3dZUTVxhZ8JNVyxYY6ooCjB2"
    #print(dealer_id)
    # Get dealers from the URL
...
def add_review(request, dealer_id):
    ...
    if request.method == 'GET':
        ...
        if (request.user.is_authenticated):
            ...
            json_result = post_request("https://27d31e05.eu-gb.apigw.appdomain.cloud/api/review", { "review": review }, dealerId=dealer_id)
